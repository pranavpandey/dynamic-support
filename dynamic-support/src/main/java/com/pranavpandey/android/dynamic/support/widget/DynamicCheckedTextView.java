...
/**
 * A {@link AppCompatCheckedTextView} to apply {@link DynamicTheme} according to the
 * supplied parameters.
 */
public class DynamicCheckedTextView extends
        AppCompatCheckedTextView implements DynamicStateWidget {
    ...
    public DynamicCheckedTextView(@NonNull Context context) {
        this(context, null);
    }

    public DynamicCheckedTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, 
                R.styleable.DynamicCheckedTextView);
        ...
        try {
            ...
            mContrast = a.getInteger(
                    R.styleable.DynamicCheckedTextView_adt_contrast,
                    Theme.Contrast.AUTO);
        } finally {
            a.recycle();
        }
            ...
            if (DynamicSdkUtils.is23()) {
                ...
                for (Drawable compoundDrawable : compoundDrawables) {
                    if (compoundDrawable != null) {
                        DynamicDrawableUtils.colorizeDrawable(compoundDrawable, mAppliedColor);
                    }
                }
            }
        }
