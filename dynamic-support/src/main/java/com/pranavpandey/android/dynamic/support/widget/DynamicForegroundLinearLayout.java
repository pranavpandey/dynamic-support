...
/**
 * A {@link ForegroundLinearLayout} to apply {@link DynamicTheme} according to the
 * supplied parameters.
 */
@SuppressLint("RestrictedApi")
public class DynamicForegroundLinearLayout extends ForegroundLinearLayout
    ...
    public DynamicForegroundLinearLayout(@NonNull Context context) {
        this(context, null);
    }

    public DynamicForegroundLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, 
                R.styleable.DynamicForegroundLinearLayout);

        try {
            mColorType = a.getInt(
                    R.styleable.DynamicForegroundLinearLayout_adt_colorType,
                    Theme.ColorType.NONE);
            mContrastWithColorType = a.getInt(
                    R.styleable.DynamicForegroundLinearLayout_adt_contrastWithColorType,
                    Theme.ColorType.BACKGROUND);
            mColor = a.getColor(
                    R.styleable.DynamicForegroundLinearLayout_adt_color,
                    Theme.Color.UNKNOWN);
            mContrastWithColor = a.getColor(
                    R.styleable.DynamicForegroundLinearLayout_adt_contrastWithColor,
                    Defaults.getContrastWithColor(getContext()));
            mBackgroundAware = a.getInteger(
                    R.styleable.DynamicForegroundLinearLayout_adt_backgroundAware,
                    Theme.BackgroundAware.DISABLE);
            mContrast = a.getInteger(
                    R.styleable.DynamicForegroundLinearLayout_adt_contrast,
                    Theme.Contrast.AUTO);
            mTintBackground = a.getBoolean(
                    R.styleable.DynamicForegroundLinearLayout_adt_tintBackground,
                    Defaults.ADS_TINT_BACKGROUND);
            mStyleBorderless = a.getBoolean(
                    R.styleable.DynamicForegroundLinearLayout_adt_styleBorderless,
