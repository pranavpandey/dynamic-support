...
/**
 * A {@link NavigationMenuItemView} to apply {@link DynamicTheme} according to the
 * supplied parameters.
 */
@SuppressLint("RestrictedApi")
public class DynamicNavigationMenuItemView extends NavigationMenuItemView
    ...
    public DynamicNavigationMenuItemView(@NonNull Context context) {
        this(context, null);
    }

    public DynamicNavigationMenuItemView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, 
                R.styleable.DynamicNavigationMenuItemView);
        ...
        try {
            ...
            mContrast = a.getInteger(
                    R.styleable.DynamicNavigationMenuItemView_adt_contrast,
                    Theme.Contrast.AUTO);
