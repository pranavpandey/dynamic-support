 ...
 */
public class InfoBigCardBinder extends InfoBigBinder {
     ...
     */
    public InfoBigCardBinder(@NonNull DynamicBinderAdapter<?> binderAdapter) {
        super(binderAdapter);
    }
    ...
    public @NonNull ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.ads_layout_info_big_card, parent, false));
    }
}
