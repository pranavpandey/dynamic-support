...
/**
 * A {@link LinearProgressIndicator} to apply {@link DynamicTheme} according to the
 * supplied parameters.
 */
public class DynamicLinearProgressIndicator extends LinearProgressIndicator 
    ...
    public DynamicLinearProgressIndicator(@NonNull Context context) {
        this(context, null);
    }

    public DynamicLinearProgressIndicator(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs,
                R.styleable.DynamicLinearProgressIndicator);

        try {
            mColorType = a.getInt(
                    R.styleable.DynamicLinearProgressIndicator_adt_colorType,
                    Theme.ColorType.ACCENT);
            mContrastWithColorType = a.getInt(
                    R.styleable.DynamicLinearProgressIndicator_adt_contrastWithColorType,
                    Theme.ColorType.BACKGROUND);
            mColor = a.getColor(
                    R.styleable.DynamicLinearProgressIndicator_adt_color,
                    Theme.Color.UNKNOWN);
            mContrastWithColor = a.getColor(
                    R.styleable.DynamicLinearProgressIndicator_adt_contrastWithColor,
                    Defaults.getContrastWithColor(getContext()));
            mBackgroundAware = a.getInteger(
                    R.styleable.DynamicLinearProgressIndicator_adt_backgroundAware,
                    Defaults.getBackgroundAware());
            mContrast = a.getInteger(
                    R.styleable.DynamicLinearProgressIndicator_adt_contrast,
                    Theme.Contrast.AUTO);
        } finally {
            a.recycle();
        }
