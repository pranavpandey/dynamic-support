...
/**
 * A {@link DynamicDataBinder} to bind the {@link DynamicInfo} that can be used with
 * the {@link DynamicBinderAdapter}.
 */
public class InfoBigBinder extends DynamicDataBinder<DynamicInfo, InfoBigBinder.ViewHolder> {
     ...
     */
    public InfoBigBinder(@NonNull DynamicBinderAdapter<?> binderAdapter) {
        super(binderAdapter);
    }
    ...
    public @NonNull ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.ads_layout_info_big, parent, false));
    }
