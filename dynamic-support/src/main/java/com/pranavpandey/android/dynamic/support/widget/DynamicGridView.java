...
/**
 * A {@link GridView} to apply {@link DynamicTheme} according to the supplied parameters.
 */
public class DynamicGridView extends GridView
    ...
    public DynamicGridView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        ...
        try {
            ...
            mContrast = a.getInteger(
                    R.styleable.DynamicGridView_adt_contrast,
                    Theme.Contrast.AUTO);
