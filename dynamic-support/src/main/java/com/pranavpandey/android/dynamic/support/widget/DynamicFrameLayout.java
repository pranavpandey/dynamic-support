...
public class DynamicFrameLayout extends FrameLayout implements DynamicWidget, DynamicTintWidget {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        ...
        try {
            mColorType = a.getInt(
                    R.styleable.DynamicFrameLayout_adt_colorType,
                    Theme.ColorType.NONE);
            mContrastWithColorType = a.getInt(
                    R.styleable.DynamicFrameLayout_adt_contrastWithColorType,
                    Theme.ColorType.BACKGROUND);
            mColor = a.getColor(
                    R.styleable.DynamicFrameLayout_adt_color,
                    Theme.Color.UNKNOWN);
            mContrastWithColor = a.getColor(
                    R.styleable.DynamicFrameLayout_adt_contrastWithColor,
                    Defaults.getContrastWithColor(getContext()));
            mBackgroundAware = a.getInteger(
                    R.styleable.DynamicFrameLayout_adt_backgroundAware,
                    Theme.BackgroundAware.DISABLE);
            mContrast = a.getInteger(
                    R.styleable.DynamicFrameLayout_adt_contrast,
                    Theme.Contrast.AUTO);
            mTintBackground = a.getBoolean(
                    R.styleable.DynamicFrameLayout_adt_tintBackground,
                    Defaults.ADS_TINT_BACKGROUND);
            mStyleBorderless = a.getBoolean(
                    R.styleable.DynamicFrameLayout_adt_styleBorderless,
