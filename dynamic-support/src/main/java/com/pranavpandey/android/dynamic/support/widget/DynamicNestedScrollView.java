...
/**
 * A NestedScrollView to apply color filter according to the supplied parameters.
 */
public class DynamicNestedScrollView extends NestedScrollView implements DynamicScrollableWidget {
