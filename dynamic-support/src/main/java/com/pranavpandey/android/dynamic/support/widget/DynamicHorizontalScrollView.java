...
/**
 * A {@link HorizontalScrollView} to apply {@link DynamicTheme} according to the
 * supplied parameters.
 */
public class DynamicHorizontalScrollView extends HorizontalScrollView
    ...
    public DynamicHorizontalScrollView(@NonNull Context context) {
        this(context, null);
    }

    public DynamicHorizontalScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
