 ...
 */
public class DynamicMaterialSwitch extends MaterialSwitch implements DynamicStateWidget {
    ...
    public DynamicMaterialSwitch(@NonNull Context context) {
        this(context, null);
    }

    public DynamicMaterialSwitch(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, 
                R.styleable.DynamicMaterialSwitch);

        try {
            mColorType = a.getInt(
                    R.styleable.DynamicMaterialSwitch_adt_colorType,
                    Theme.ColorType.ACCENT);
            mContrastWithColorType = a.getInt(
                    R.styleable.DynamicMaterialSwitch_adt_contrastWithColorType,
                    Theme.ColorType.BACKGROUND);
            mStateNormalColorType = a.getInt(
                    R.styleable.DynamicMaterialSwitch_adt_stateNormalColorType,
                    Defaults.ADS_COLOR_TYPE_ICON);
            mColor = a.getColor(
                    R.styleable.DynamicMaterialSwitch_adt_color,
                    Theme.Color.UNKNOWN);
            mContrastWithColor = a.getColor(
                    R.styleable.DynamicMaterialSwitch_adt_contrastWithColor,
                    Defaults.getContrastWithColor(getContext()));
            mStateNormalColor = a.getColor(
                    R.styleable.DynamicMaterialSwitch_adt_stateNormalColor,
                    Theme.Color.UNKNOWN);
            mBackgroundAware = a.getInteger(
                    R.styleable.DynamicMaterialSwitch_adt_backgroundAware,
                    Defaults.getBackgroundAware());
            mContrast = a.getInteger(
                    R.styleable.DynamicMaterialSwitch_adt_contrast,
                    Theme.Contrast.AUTO);
        } finally {
            a.recycle();
        }
