...
/**
 * An {@link FloatingToolbarLayout} to apply {@link DynamicTheme} according to the
 * supplied parameters.
 */
public class DynamicFloatingToolbar extends FloatingToolbarLayout
    ...
    public DynamicFloatingToolbar(@NonNull Context context) {
        this(context, null);
    }

    public DynamicFloatingToolbar(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, 
                R.styleable.DynamicFloatingToolbar);

        try {
            mColorType = a.getInt(
                    R.styleable.DynamicFloatingToolbar_adt_colorType,
                    Theme.ColorType.ACCENT);
            mContrastWithColorType = a.getInt(
                    R.styleable.DynamicFloatingToolbar_adt_contrastWithColorType,
                    Theme.ColorType.BACKGROUND);
            mColor = a.getColor(
                    R.styleable.DynamicFloatingToolbar_adt_color,
                    Theme.Color.UNKNOWN);
            mContrastWithColor = a.getColor(
                    R.styleable.DynamicFloatingToolbar_adt_contrastWithColor,
                    Defaults.getContrastWithColor(getContext()));
            mBackgroundAware = a.getInteger(
                    R.styleable.DynamicFloatingToolbar_adt_backgroundAware,
                    Defaults.getBackgroundAware());
            mContrast = a.getInteger(
                    R.styleable.DynamicFloatingToolbar_adt_contrast,
                    Theme.Contrast.AUTO);

            if (a.getBoolean(
                    R.styleable.DynamicFloatingToolbar_adt_dynamicCornerSize,
    ...
    public void setCorner(@NonNull Integer cornerSize) {
        ...
        if (getBackground() instanceof MaterialShapeDrawable) {
            ((MaterialShapeDrawable) getBackground()).setShapeAppearanceModel(
                    ((MaterialShapeDrawable) getBackground()).getShapeAppearanceModel()
