...
/**
 * A {@link HeaderBinder} to bind the
 * {@link com.pranavpandey.android.dynamic.support.view.DynamicHeader} inside a
...
public class HeaderCardBinder extends HeaderBinder {
     ...
     */
    public HeaderCardBinder(@NonNull DynamicBinderAdapter<?> binderAdapter) {
        super(binderAdapter);
    }
    ...
    public @NonNull ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.ads_layout_header_card, parent, false), R.id.ads_header);
    }
}
