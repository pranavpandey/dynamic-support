 ...
 */
public class AuthorInfoBinder extends DynamicRecyclerViewBinder {

    public AuthorInfoBinder(@NonNull DynamicBinderAdapter dynamicBinderAdapter) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            dynamicInfoView = view.findViewById(R.id.info_author);
